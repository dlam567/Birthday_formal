...
// iframe 处理
let iframe = document.getElementById('welcome');
// var innerDoc = iframe.contentDocument || iframe.contentWindow.document;
// var MediaSource = innerDoc.getElementsByTagName("video")[0];
...
// console.log(pat)
// document.styleSheets[0].addRule('#bg:after','background-image:url(\\"../../images/"+picSc+".jpg\\")')
...
$("#login-button").click(function (event) {
  ...
  userList = document.getElementsByClassName("uName")
	// console.log(userList)
	// console.log(parseInt(userList.length))
				...
				// Close.
					$('<div class="close">Close</div>')
						...
						.on('click', function() {
							...
							console.log("Close");
							if (iframe) {
								iframe.parentNode.removeChild(iframe); // 从父节点中移除对象
							} else {
								console.log("未找到指定的对象！");
							}
						});
